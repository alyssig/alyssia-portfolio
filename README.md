...
* `script.js` - routing, particle art, carousel, experience tabs, Game Mode, and mini game

## How to deploy on Netlify

1. Go to https://app.netlify.com/drop
2. Drag this whole folder onto the page. No build command is needed.

You can also connect this GitHub repo to Netlify and deploy from the `main` branch.

## To customize

* Edit the experiences, projects, and hardware arrays at the top of `script.js` to update rendered content.
